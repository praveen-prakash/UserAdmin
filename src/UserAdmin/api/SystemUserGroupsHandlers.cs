    ...
    public class SystemUserGroupsHandlers {
        public static void Register() {
            ...
            Handle.GET("/UserAdmin/admin/createusergroup", (Request request) => {
                ...
                return new Partials.Administrator.CreateUserGroupPage() { Html = "/UserAdmin/viewmodels/partials/administrator/CreateUserGroupPage.html", Uri = request.Uri };
            });
            ...
            Handle.GET("/UserAdmin/admin/usergroups", (Request request) => {
                ...
                return new Partials.Administrator.ListUserGroupsPage() { Html = "/UserAdmin/viewmodels/partials/administrator/ListUserGroupsPage.html", Uri = request.Uri };
