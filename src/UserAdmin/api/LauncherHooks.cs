    ...
    public class LauncherHooks {
        public static void Register() {
            ...
            Starcounter.Handle.GET("/useradmin/app-icon", () => {
                return new Page() { Html = "/UserAdmin/viewmodels/launcher/AppIcon.html" };
            });
            ...
            Starcounter.Handle.GET("/useradmin/menu", () => {
                ...
                var menuPage = new AdminMenu() {
                    Html = "/UserAdmin/viewmodels/launcher/AdminMenu.html",
            ...
            Starcounter.Handle.GET("/useradmin/search/{?}", (string query) => {
                var result = new UserAdmin.Partials.Administrator.SearchResultPage();
                result.Html = "/UserAdmin/viewmodels/launcher/AppSearch.html";
