    ...
    public class SystemUsersHandlers {
        ...
        public static void Register() {
            ...
            Starcounter.Handle.GET("/useradmin/admin/createuser", (Request request) => {
                ...
                return new Partials.Administrator.CreateUserPage() { Html = "/UserAdmin/viewmodels/partials/administrator/CreateUserPage.html", Uri = request.Uri };
            });
            ...
            Starcounter.Handle.GET("/useradmin/admin/users", (Request request) => {
                ...
                return new Partials.Administrator.ListUsersPage() { Html = "/UserAdmin/viewmodels/partials/administrator/ListUsersPage.html", Uri = request.Uri };
            });
